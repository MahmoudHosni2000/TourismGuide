...
// import restaurants from '../Data/RD';
...
const RestaurantList = ({ restaurants }) => {
  console.log(Array.isArray(restaurants)); // Should log `true`
  console.log(restaurants); // Check the data structure
      ...
      <div className="row justify-content-center" style={{ marginTop: '5rem', }}>
        {Array.isArray(restaurants) ? (
          restaurants.map((restaurant) => {
            ...
            return (
              <div className="col-md-4 mb-4" key={restaurant.properties["@id"]}>
                <div className="card rounded-3">
                  <img
                    src={restaurant.properties.image}
                    className="card-img-top2 rounded-3"
                    alt={restaurant.properties.name}
                  />
                  <div className="card-body">
                    <h4 className="main-colors mb-0 pb-0">{restaurant.properties.name}</h4>
                    ...
                    <div className="d-flex align-items-start position-absolute top-0 end-0 py-1 px-1 rounded-start-3 bg-white">
                      ...
                      <p className="text-black card-text px-1">
                        {restaurant.properties.stars}
                      </p>
                    </div>

                    <span className='pb-2'>" {restaurant.properties.cuisine} "</span>
                    <p className="text-muted mt-2">
                      {restaurant.properties.description}
                    </p>

                    <div className="d-flex align-items-center">
                      <img src={icon1} alt="" width={21} />
                      <p className="text-muted card-text px-1">
                        {restaurant.properties.phone}
                      </p>
                    </div>
                    <div className="d-flex align-items-center">
                    ...
                    {/* <div className="d-flex align-items-center py-1">
                      ...
                      <a href={restaurant.properties.website} className="text-primary card-text px-1">
                        Visit Website
                      </a>
                    </div> */}
                    <small className="text-muted">
                      ...
                      <ul className="list-unstyled mt-2">
                        {restaurant.properties.reviews.map((review, index) => (
                          <li key={index}>
